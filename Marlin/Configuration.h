...
#define STRING_CONFIG_H_AUTHOR "Guilherme Henique de Moura Froes" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ulyana"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 3300, 192 }

//Compensar sonda = 2.41 - 2.39
